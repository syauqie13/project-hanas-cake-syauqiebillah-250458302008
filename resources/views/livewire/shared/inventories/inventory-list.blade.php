                            ...
                            <div class="card-header">
                                ...
                                <div class="card-header-form">
                                    <div class="input-group">
                                        <input wire:model.live.debounce.300ms="search" type="text" class="form-control" placeholder="Cari item (Tepung, Gula...)">
                                    ...
                                    <table class="table mb-0 table-striped table-md">
                                        <thead class="text-white">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-center align-middle">Harga Satuan (Modal)</th>
                                            ...
                                            @forelse ($inventories as $index => $item)
                                                <tr class="hover-highlight">
                                                    ...
                                                    <td class="align-middle font-weight-600 text-dark">
                                                        {{ $item->name }}
                                                        @if($item->description)
                                                            <div class="text-xs text-muted">{{ Str::limit($item->description, 50) }}</div>
                                                        @endif
                                                    </td>
                                                    <td class="text-center align-middle">
                                                        <span class="badge {{ $item->type == 'bahan_baku' ? 'badge-warning' : 'badge-success' }}" style="text-transform: capitalize;">
                                                            {{ str_replace('_', ' ', $item->type) }}
                                                        </span>
                                                    </td>
                                                    <td class="text-center align-middle">
                                                        <span class="px-3 py-2 shadow-sm badge badge-light">
                                                            {{-- Tampilkan sebagai angka bulat (atau 2 desimal jika Anda mau) --}}
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $inventoryId ? 'Edit Item Inventaris' : 'Tambah Item Inventaris Baru' }}</h5>
                    ...
                    <form wire:submit.prevent="store">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Tepung Terigu">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="1" wire:model="stock" class="form-control @error('stock') is-invalid @enderror" placeholder="Contoh: 10000 (untuk 10.000 gram)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" wire:model="unit_price" class="form-control @error('unit_price') is-invalid @enderror" placeholder="Contoh: 15 (untuk 15/gram) atau 15000 (untuk 15000/kg)">
                            ...
                            <div class="form-group">
                                ...
                                <textarea wire:model="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Deskripsi singkat item..."></textarea>
                        ...
                        <div class="modal-footer bg-whitesmoke br">
                            ...
                            <button type="submit" class="btn btn-primary">{{ $inventoryId ? 'Perbarui' : 'Simpan' }}</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    @push('js')
        ...
        <script>
            window.addEventListener('notify', event => {
                Swal.fire({
                    // Sesuaikan 'icon' dan 'title' berdasarkan event
        ...
        <script>
            document.addEventListener('livewire:init', () => {
                Livewire.on('confirmDelete', (data) => {
                    Swal.fire({
                        title: 'Yakin hapus?',
                        text: "Data item inventaris akan dihapus permanen.",
                        icon: 'warning',
